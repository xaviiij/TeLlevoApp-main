...
@Component({
  selector: 'app-delete-autos',
  templateUrl: './delete-autos.page.html',
  styleUrls: ['./delete-autos.page.scss'],
})
export class DeleteAutosPage {
  ...
  eliminarAuto(){
    this.autoServ.eliminarAuto(this.Auto).subscribe()
